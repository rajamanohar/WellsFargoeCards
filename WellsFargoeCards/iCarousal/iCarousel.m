...
- (void)stopAnimation
{
    ...
    [dict setValue:[NSString stringWithFormat:@"%ld",self.currentItemIndex] forKey:@"index_value"];
    
    // Handling tap gesture to show QRCode
    [[NSNotificationCenter defaultCenter]
     postNotificationName:@"panGestureNotificaiton"
...
- (void)didTap:(UITapGestureRecognizer *)tapGesture
{
    ...
    // Handling tap gesture to show QRCode
    [[NSNotificationCenter defaultCenter]
     postNotificationName:@"tapGestureNotificaiton"
     object:self];
